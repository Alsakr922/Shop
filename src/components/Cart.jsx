...
const Cart = () => {
  ...
  return (
    <section className="container m-auto cart-section">
      <div className="cart-bg flexCenter my-[50px] py-[100px] font-light lg:text-[200px] text-[100px]  leading-[64px] text-white">
        <>Cart</>
      </div>
      <table className="w-full m-auto py-[200px] ">
        ...
        <tbody className="mt-5 lg:text-lg md:text-md sm:text-sm">
          {cart.map((product) => {
            return (
              <tr className="m-auto container ">
                <td className="lg:p-3 p-1 font-semibold cursor-pointer">
                  <FaEraser onClick={() => dispatch(removeFromCart(product))} />
                </td>
                <td className="lg:p-3 p-[2px] font-semibold">
                ...
                <td className="lg:p-3 p-[2px] font-semiold">
                  َ{product.amount}
                </td>
                <td className="lg:p-3 p-[2px] font-semibold">
                  َ{+product.newPrice * +product.amount}
                </td>
              </tr>
            );
          })}
